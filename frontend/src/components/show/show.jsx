          ...
          <div className="show">
            ...
            <section className="show-instructions">
              <div className="read-me-img">
                <p className="quote">
                  “We abide by the old adage — quality over quantity. While we
                  now have a large database built over time, the quality of
                  meals has always been at the forefront.”
            ...
            <section className="show-steps">
              ...
              <div className="follow-me-img">
                <p className="quote">
                  “My family and I are a walking testament that the process
                  works, but rather than hear me talk about it we’ll let the
